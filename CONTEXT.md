...
**Updated:** 2026-08-09, after the aligned printed-ending, writing-workspace, exact-position, and bol-menu pass. The July 30 product rulings below remain binding except where this checkpoint explicitly supersedes them.
...
- Verification at this checkpoint: **596 checks passed, 0 failed**; the production build succeeded with the existing non-blocking large-chunk advisory.
